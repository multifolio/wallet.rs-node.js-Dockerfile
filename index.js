/**
 * This example creates a new database, account and an address for the first account
 */
...
async function run() {
    try {
        ...
        // added code to generate address
        const address = await account.generateAddress();
        console.log('New address of alice account:', address);
